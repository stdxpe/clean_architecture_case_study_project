...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( NetworkFailure value)?  network,TResult Function( ServerFailure value)?  server,TResult Function( StorageFailure value)?  storage,TResult Function( ParsingFailure value)?  parsing,TResult Function( UnauthorizedFailure value)?  unauthorized,TResult Function( NoConnectionFailure value)?  noConnection,TResult Function( NotFoundFailure value)?  notFound,TResult Function( UnexpectedFailure value)?  unexpected,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return unauthorized(_that);case NoConnectionFailure() when noConnection != null:
return noConnection(_that);case NotFoundFailure() when notFound != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( NetworkFailure value)  network,required TResult Function( ServerFailure value)  server,required TResult Function( StorageFailure value)  storage,required TResult Function( ParsingFailure value)  parsing,required TResult Function( UnauthorizedFailure value)  unauthorized,required TResult Function( NoConnectionFailure value)  noConnection,required TResult Function( NotFoundFailure value)  notFound,required TResult Function( UnexpectedFailure value)  unexpected,}){
final _that = this;
switch (_that) {
case NetworkFailure():
...
return unauthorized(_that);case NoConnectionFailure():
return noConnection(_that);case NotFoundFailure():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( NetworkFailure value)?  network,TResult? Function( ServerFailure value)?  server,TResult? Function( StorageFailure value)?  storage,TResult? Function( ParsingFailure value)?  parsing,TResult? Function( UnauthorizedFailure value)?  unauthorized,TResult? Function( NoConnectionFailure value)?  noConnection,TResult? Function( NotFoundFailure value)?  notFound,TResult? Function( UnexpectedFailure value)?  unexpected,}){
final _that = this;
switch (_that) {
case NetworkFailure() when network != null:
return network(_that);case ServerFailure() when server != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String message)?  network,TResult Function( int code,  String message)?  server,TResult Function( String message)?  storage,TResult Function( String message)?  parsing,TResult Function( String message)?  unauthorized,TResult Function( String message)?  noConnection,TResult Function( String message)?  notFound,TResult Function( String message)?  unexpected,required TResult orElse(),}) {final _that = this;
switch (_that) {
case NetworkFailure() when network != null:
return network(_that.message);case ServerFailure() when server != null:
return server(_that.code,_that.message);case StorageFailure() when storage != null:
return storage(_that.message);case ParsingFailure() when parsing != null:
return parsing(_that.message);case UnauthorizedFailure() when unauthorized != null:
return unauthorized(_that.message);case NoConnectionFailure() when noConnection != null:
return noConnection(_that.message);case NotFoundFailure() when notFound != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String message)  network,required TResult Function( int code,  String message)  server,required TResult Function( String message)  storage,required TResult Function( String message)  parsing,required TResult Function( String message)  unauthorized,required TResult Function( String message)  noConnection,required TResult Function( String message)  notFound,required TResult Function( String message)  unexpected,}) {final _that = this;
switch (_that) {
case NetworkFailure():
return network(_that.message);case ServerFailure():
return server(_that.code,_that.message);case StorageFailure():
return storage(_that.message);case ParsingFailure():
return parsing(_that.message);case UnauthorizedFailure():
return unauthorized(_that.message);case NoConnectionFailure():
return noConnection(_that.message);case NotFoundFailure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String message)?  network,TResult? Function( int code,  String message)?  server,TResult? Function( String message)?  storage,TResult? Function( String message)?  parsing,TResult? Function( String message)?  unauthorized,TResult? Function( String message)?  noConnection,TResult? Function( String message)?  notFound,TResult? Function( String message)?  unexpected,}) {final _that = this;
switch (_that) {
case NetworkFailure() when network != null:
return network(_that.message);case ServerFailure() when server != null:
return server(_that.code,_that.message);case StorageFailure() when storage != null:
