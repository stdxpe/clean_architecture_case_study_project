...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignInStatus);
}
...
/// @nodoc
class $SignInStatusCopyWith<$Res>  {
$SignInStatusCopyWith(SignInStatus _, $Res Function(SignInStatus) __);
}


/// Adds pattern-matching-related methods to [SignInStatus].
extension SignInStatusPatterns on SignInStatus {
...
class _Initial implements SignInStatus {
  const _Initial();
...
class _Loading implements SignInStatus {
  const _Loading();
...
class _Success implements SignInStatus {
  const _Success();
...
class _Failure implements SignInStatus {
...
@override
String toString() {
  return 'SignInStatus.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $SignInStatusCopyWith<$Res> {
