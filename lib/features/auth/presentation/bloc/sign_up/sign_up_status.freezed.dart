...
class _Initial implements SignUpStatus {
  const _Initial();
...
class _Loading implements SignUpStatus {
  const _Loading();
...
class _Success implements SignUpStatus {
  const _Success();
...
class _Failure implements SignUpStatus {
...
@override
String toString() {
  return 'SignUpStatus.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $SignUpStatusCopyWith<$Res> {
