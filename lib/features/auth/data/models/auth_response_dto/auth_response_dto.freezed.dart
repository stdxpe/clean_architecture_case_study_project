...
@JsonKey(name: 'response') ResponseInfoDto get info;@JsonKey(name: 'data') UserModel get userModel;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthResponseDto&&(identical(other.info, info) || other.info == info)&&(identical(other.userModel, userModel) || other.userModel == userModel));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,info,userModel);

@override
String toString() {
  return 'AuthResponseDto(info: $info, userModel: $userModel)';
}
...
@useResult
$Res call({
@JsonKey(name: 'response') ResponseInfoDto info,@JsonKey(name: 'data') UserModel userModel
});


$ResponseInfoDtoCopyWith<$Res> get info;$UserModelCopyWith<$Res> get userModel;
...
/// Create a copy of AuthResponseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? info = null,Object? userModel = null,}) {
  return _then(_self.copyWith(
info: null == info ? _self.info : info // ignore: cast_nullable_to_non_nullable
as ResponseInfoDto,userModel: null == userModel ? _self.userModel : userModel // ignore: cast_nullable_to_non_nullable
as UserModel,
  ));
}
/// Create a copy of AuthResponseDto
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'response')  ResponseInfoDto info, @JsonKey(name: 'data')  UserModel userModel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseDto() when $default != null:
return $default(_that.info,_that.userModel);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'response')  ResponseInfoDto info, @JsonKey(name: 'data')  UserModel userModel)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseDto():
return $default(_that.info,_that.userModel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'response')  ResponseInfoDto info, @JsonKey(name: 'data')  UserModel userModel)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseDto() when $default != null:
return $default(_that.info,_that.userModel);case _:
  return null;
...
class _AuthResponseDto extends AuthResponseDto {
  const _AuthResponseDto({@JsonKey(name: 'response') required this.info, @JsonKey(name: 'data') required this.userModel}): super._();
...
@override@JsonKey(name: 'data') final  UserModel userModel;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthResponseDto&&(identical(other.info, info) || other.info == info)&&(identical(other.userModel, userModel) || other.userModel == userModel));
}
...
@override $ResponseInfoDtoCopyWith<$Res> get info;@override $UserModelCopyWith<$Res> get userModel;
...
/// Create a copy of AuthResponseDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? info = null,Object? userModel = null,}) {
